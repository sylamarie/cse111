...
def pressure_gain_from_water_height(height):
    kilopascals_pressure = (WATER_DENSITY * EARTH_ACCELERATION_OF_GRAVITY * height) / 1000
...
def kpa_to_psi(kpa):
    return kpa * 0.14503773773  # 1 kPa = 0.14503773773 psi
...
def main():
    ...
    print(f"Pressure at house: {pressure_psi:.1f} per square inch (psi)")
